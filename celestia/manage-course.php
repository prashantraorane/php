...
<html lang="en">
    <head>
        ...
        <title>Celestia Computer Institute | Manage Courses</title>
...
<tr>
 <td><?php echo ($cnt);?></td>
                                                            <td><center><img src="<?php echo ($result->FilePath); ?>" alt="Image"width="75" height="75"></center></td>
...
<td>
<a href="edit-course.php?courseid=<?php echo ($result->id);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
