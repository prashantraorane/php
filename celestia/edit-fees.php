...
$remark=$_POST['remark'];
$sql="INSERT INTO  tblfees(FRollId,FName,FCourseId,FAmount,FBalance) VALUES (:rollid,:sname,:courseid,:amount,:balance)";
...
<html lang="en">
    <head>
        ...
        <title>Shine Computer Institute | Edit Fee's  </title>
...
<label for="default" class="col-sm-2 control-label">Course Name</label>
	...
	<label for="default" class="col-sm-2 control-label">Amount </label>
        <div class="col-sm-4">
            <input type="text" name="amount" class="form-control" id="amount" onkeyup="sum();" value="<?php echo htmlentities($result->Amount)?>">
        </div>
